...
\begin{itemize}
\item A recap on the general linear model
\item Models for binary data
\item Models for multinomial data
\item Models for discrete proportions
\item Models for count data
\item Extensions: overdispersion models
\item Extensions: zero-inflated models
\end{itemize}
