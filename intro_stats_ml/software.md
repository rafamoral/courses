...
```r
install.packages(c("ISLR", "glmnet", "GGally", "BiocManager", "dendextend", "splines", "class", "caret", "arm", "MLeval", "pROC", "gclus", "seriation", "DendSer", "leaps", "gam", "rpart", "rpart.plot", "kernlab", "randomForest", "gamlss", "gamlss.add"))
