...
```r
install.packages(c("ISLR", "glmnet", "GGally", "BiocManager", "dendextend", "splines", "class", "caret", "arm", "MLeval", "pROC", "gclus", "seriation", "DendSer", "leaps", "gridExtra", "gam", "rpart", "rpart.plot", "kernlab", "randomForest", "hnp", "dbarts", "gamlss", "gamlss.add"))
